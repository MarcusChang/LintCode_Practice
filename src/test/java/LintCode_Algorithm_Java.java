...
public class LintCode_Algorithm_Java {
    ...
    * */
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/closest-number-in-sorted-array/
     * @param A an integer array sorted in ascending order
     * @param target an integer
     * @return an integer
     */
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/k-closest-numbers-in-sorted-array/
    ...
    public int[] kClosestNumbers(int[] A, int target, int k) {
        ...
        int index = firstIndexOfkClosestNumbers(A, target);
    ...
    private int firstIndexOfkClosestNumbers(int[] A, int target) {
        int start = 0, end = A.length - 1;
        while (start + 1 < end) {
            int mid = start + (end - start) / 2;
            if (A[mid] < target) {
    ...
    * */
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/lowest-common-ancestor-ii/
    ...
    * */
    ...
    void swapColors(int left, int right, int[] colors) {
        int tmp = colors[left];
     ...
     * @param num : Give an array numbersbers of n integer
    ...
    * */
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/max-tree/
    ...
    * */
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/string-permutation-ii/
     * @param str a string
    ...
    /**
     * http://www.lintcode.com/zh-cn/problem/find-the-connected-component-in-the-undirected-graph/
